...
class _ForgetPasswordState extends State<ForgetPassword>with TickerProviderStateMixin {
  ...
  final TextEditingController _forgetPassTextControlller = TextEditingController(text: '');
  ...
  void _forgetPassSubmitForm() async
  {
    try
    {
      await _auth.sendPasswordResetEmail(
        email: _forgetPassTextControlller.text,
      );
          ...
          Padding(
            ...
            child: ListView(
              children: [
                ...
                TextField(
                  controller: _forgetPassTextControlller,
