                  ...
                  try {
                    if(widget.uploadBy == _uid)
                    {
                      ...
                      await Fluttertoast.showToast
                        ...
                        toastLength: Toast.LENGTH_LONG, backgroundColor: Colors.grey,
                        fontSize: 18.0,
                      );
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        leading: Container(
          padding: const EdgeInsets.only(right: 12), decoration: const BoxDecoration (
          border: Border (
